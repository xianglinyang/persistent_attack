...
# --- Average over all LLMs ---

# Sliding Window (avg gemini + glm)
python -m src.analysis.plot_from_saved \
  --avg_llm_sw_series "Ours:${ROOT}/sliding_window/metrics_exposure_google_gemini-2.5-flash_zombie_completion_real_data-for-agents_insta-150k-v1.json:${ROOT}/sliding_window/metrics_trigger_google_gemini-2.5-flash_zombie_completion_real_data-for-agents_insta-150k-v1.json:${ROOT}/sliding_window/metrics_exposure_z-ai_glm-4.7-flash_zombie_completion_real_data-for-agents_insta-150k-v1.json:${ROOT}/sliding_window/metrics_trigger_z-ai_glm-4.7-flash_zombie_completion_real_data-for-agents_insta-150k-v1.json" \
  --avg_llm_sw_series "IPI Naive:${ROOT}/sliding_window/metrics_exposure_google_gemini-2.5-flash_ipi_naive_data-for-agents_insta-150k-v1.json:${ROOT}/sliding_window/metrics_trigger_google_gemini-2.5-flash_ipi_naive_data-for-agents_insta-150k-v1.json:${ROOT}/sliding_window/metrics_exposure_z-ai_glm-4.7-flash_ipi_naive_data-for-agents_insta-150k-v1.json:${ROOT}/sliding_window/metrics_trigger_z-ai_glm-4.7-flash_ipi_naive_data-for-agents_insta-150k-v1.json" \
  --avg_llm_sw_series "IPI Ignore:${ROOT}/sliding_window/metrics_exposure_google_gemini-2.5-flash_ipi_ignore_data-for-agents_insta-150k-v1.json:${ROOT}/sliding_window/metrics_trigger_google_gemini-2.5-flash_ipi_ignore_data-for-agents_insta-150k-v1.json:${ROOT}/sliding_window/metrics_exposure_z-ai_glm-4.7-flash_ipi_ignore_data-for-agents_insta-150k-v1.json:${ROOT}/sliding_window/metrics_trigger_z-ai_glm-4.7-flash_ipi_ignore_data-for-agents_insta-150k-v1.json" \
  --avg_llm_sw_series "IPI Escape:${ROOT}/sliding_window/metrics_exposure_google_gemini-2.5-flash_ipi_escape_deletion_data-for-agents_insta-150k-v1.json:${ROOT}/sliding_window/metrics_trigger_google_gemini-2.5-flash_ipi_escape_deletion_data-for-agents_insta-150k-v1.json:${ROOT}/sliding_window/metrics_exposure_z-ai_glm-4.7-flash_ipi_escape_deletion_data-for-agents_insta-150k-v1.json:${ROOT}/sliding_window/metrics_trigger_z-ai_glm-4.7-flash_ipi_escape_deletion_data-for-agents_insta-150k-v1.json" \
  --avg_llm_sw_series "IPI FakeComp:${ROOT}/sliding_window/metrics_exposure_google_gemini-2.5-flash_ipi_completion_real_data-for-agents_insta-150k-v1.json:${ROOT}/sliding_window/metrics_trigger_google_gemini-2.5-flash_ipi_completion_real_data-for-agents_insta-150k-v1.json:${ROOT}/sliding_window/metrics_exposure_z-ai_glm-4.7-flash_ipi_completion_real_data-for-agents_insta-150k-v1.json:${ROOT}/sliding_window/metrics_trigger_z-ai_glm-4.7-flash_ipi_completion_real_data-for-agents_insta-150k-v1.json" \
  --avg_llm_sw_save_dir ./avg_llm_plots

# RAG (avg gemini + glm)
python -m src.analysis.plot_from_saved \
  --avg_llm_rag_series "Ours:${ROOT}/gemini_raw_db/msmarco/log_results/metrics_exposure_google_gemini-2.5-flash_zombie_completion_real_data-for-agents_insta-150k-v1_0_None_raw.json:${ROOT}/gemini_raw_db/msmarco/log_results/metrics_trigger_google_gemini-2.5-flash_zombie_completion_real_data-for-agents_insta-150k-v1_0_None_raw.json:${ROOT}/glm_raw_db/msmarco/log_results/exposure_metrics.json:${ROOT}/glm_raw_db/msmarco/log_results/metrics_trigger_z-ai_glm-4.7-flash_zombie_completion_real_data-for-agents_insta-150k-v1_0_None_raw.json" \
  --avg_llm_rag_series "IPI Naive:${ROOT}/gemini_ipi_naive_raw_db/msmarco/log_results/metrics_exposure_google_gemini-2.5-flash_ipi_naive_data-for-agents_insta-150k-v1_0_None_raw.json:${ROOT}/gemini_ipi_naive_raw_db/msmarco/log_results/metrics_trigger_google_gemini-2.5-flash_ipi_naive_data-for-agents_insta-150k-v1_0_None_raw.json:${ROOT}/glm_ipi_naive_raw_db/msmarco/log_results/metrics_exposure_z-ai_glm-4.7-flash_ipi_naive_data-for-agents_insta-150k-v1_0_None_raw.json:${ROOT}/glm_ipi_naive_raw_db/msmarco/log_results/metrics_trigger_z-ai_glm-4.7-flash_ipi_naive_data-for-agents_insta-150k-v1_0_None_raw.json" \
  --avg_llm_rag_series "IPI Ignore:${ROOT}/gemini_ipi_ignore_raw_db/msmarco/log_results/metrics_exposure_google_gemini-2.5-flash_ipi_ignore_data-for-agents_insta-150k-v1_0_None_raw.json:${ROOT}/gemini_ipi_ignore_raw_db/msmarco/log_results/metrics_trigger_google_gemini-2.5-flash_ipi_ignore_data-for-agents_insta-150k-v1_0_None_raw.json:${ROOT}/glm_ipi_ignore_raw_db/msmarco/log_results/metrics_exposure_z-ai_glm-4.7-flash_ipi_ignore_data-for-agents_insta-150k-v1_0_None_raw.json:${ROOT}/glm_ipi_ignore_raw_db/msmarco/log_results/metrics_trigger_z-ai_glm-4.7-flash_ipi_ignore_data-for-agents_insta-150k-v1_0_None_raw.json" \
  --avg_llm_rag_series "IPI Escape:${ROOT}/gemini_ipi_escape_raw_db/msmarco/log_results/metrics_exposure_google_gemini-2.5-flash_ipi_escape_deletion_data-for-agents_insta-150k-v1_0_None_raw.json:${ROOT}/gemini_ipi_escape_raw_db/msmarco/log_results/metrics_trigger_google_gemini-2.5-flash_ipi_escape_deletion_data-for-agents_insta-150k-v1_0_None_raw.json:${ROOT}/glm_ipi_escape_raw_db/msmarco/log_results/metrics_exposure_z-ai_glm-4.7-flash_ipi_escape_deletion_data-for-agents_insta-150k-v1_0_None_raw.json:${ROOT}/glm_ipi_escape_raw_db/msmarco/log_results/metrics_trigger_z-ai_glm-4.7-flash_ipi_escape_deletion_data-for-agents_insta-150k-v1_0_None_raw.json" \
  --avg_llm_rag_series "IPI FakeComp:${ROOT}/gemini_ipi_raw_db/msmarco/log_results/metrics_exposure_google_gemini-2.5-flash_ipi_completion_real_data-for-agents_insta-150k-v1_0_None_raw.json:${ROOT}/gemini_ipi_raw_db/msmarco/log_results/metrics_trigger_google_gemini-2.5-flash_ipi_completion_real_data-for-agents_insta-150k-v1_0_None_raw.json:${ROOT}/glm_ipi_raw_db/msmarco/log_results/exposure_metrics.json:${ROOT}/glm_ipi_raw_db/msmarco/log_results/trigger_metrics.json" \
  --avg_llm_rag_save_dir ./avg_llm_plots
