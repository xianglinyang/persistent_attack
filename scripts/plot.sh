...
# # glm-4.7-flash
# python -m src.analysis.plot_from_saved \
#   --rag_series "Ours:${ROOT}/glm_raw_db/msmarco/log_results/metrics_exposure_z-ai_glm-4.7-flash_zombie_completion_real_data-for-agents_insta-150k-v1_0_None_raw.json:${ROOT}/glm_raw_db/msmarco/log_results/metrics_trigger_z-ai_glm-4.7-flash_zombie_completion_real_data-for-agents_insta-150k-v1_0_None_raw.json" \
...
#   --rag_series "IPI FakeComp:${ROOT}/glm_ipi_raw_db/msmarco/log_results/metrics_exposure_z-ai_glm-4.7-flash_ipi_completion_real_data-for-agents_insta-150k-v1_0_None_raw.json:${ROOT}/glm_ipi_raw_db/msmarco/log_results/metrics_trigger_z-ai_glm-4.7-flash_ipi_completion_real_data-for-agents_insta-150k-v1_0_None_raw.json" \
#   --rag_save_dir ./plots
