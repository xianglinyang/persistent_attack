...
Payload in Memory: {result['payload_in_memory']}
Attack Success: {result['attack_success']}
ASR Details: Exfiltration={result.get('exfiltration', False)}, Command Exec={result.get('command_exec', False)}, Reload Count={result.get('reload_payload_times', 0)}
""")
...
def pair_attack_single_iteration(
    ...
    payload_in_memory = metrics.get("rag_payload_cnt", 0) > 0
